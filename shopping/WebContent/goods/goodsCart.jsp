...
<c:forEach items="${lists }" var = "dto">
	<tr><td colspan = "3">
		...
		<td rowspan = 2 ><input type = "button" value="삭제" 
			onclick ="javascript:location.href='cartProdDel.gd?prodNum=${dto.productDTO.prodNum}';"/></td></tr>
	...
	<tr><td><img src="goods/upload/${dto.productDTO.prodImage.split(',')[0] }" width = "50"/></td>
		...
		<td align="right"><fmt:formatNumber value = "${dto.productDTO.prodPrice }" type="currency"/>원</td>
		<td align="right"><fmt:formatNumber value = "${dto.cartDTO.cartPrice }" type="currency"/>원</td>
		<td align="right"><fmt:formatNumber value = "${dto.productDTO.prodDelFee }" type="currency"/>원</td>
